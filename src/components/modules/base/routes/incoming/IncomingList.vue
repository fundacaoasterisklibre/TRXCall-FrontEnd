<template>
  <section>
    ...
    <el-table :data="table.items" highlight-current-row v-loading="loading" @selection-change="handleSelectsChange"
      ...
      <el-table-column prop="from" label="De" width="100" sortable></el-table-column>
      <el-table-column label="Para" width="350" sortable>

        <template slot-scope="scope">
          {{scope.row.to.description}} - {{scope.row.to.reference}}
        </template>
...
<script src="./IncomingList.js"></script>
